...
<tr>
	...
	<td colspan="4"><input type="password" name="config[adminpassword]" size="15" maxlength="32" value="{$config.adminpassword|htmlentities}" /> {$errors.adminpassword|checkerror}</td>
</tr>
<tr><td colspan="5"><br /></td></tr>
{/check}
<tr>
